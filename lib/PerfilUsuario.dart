  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'Nombre del Usuario', // Nombre del usuario ingresado
          style: TextStyle(fontSize: 20), // Aumentar tamaño de letra
        ),
        centerTitle: true,
      ),
      body: Column(
        ...
        children: [
          ...
          SizedBox(height: 20),
          Container(
            color: Colors.grey[400], // Incrementar opacidad de la barra gris
            child: Row(
          ...
          if (_isAdopcionSelected) ...[
            ...
            ElevatedButton(
              ...
              child: Text(
                'Añadir mascotas',
                style: TextStyle(fontSize: 16), // Reducir tamaño de letra del botón
              ),
